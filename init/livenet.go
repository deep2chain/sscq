...
import (
	...
	srvconfig "github.com/deep2chain/sscq/server/config"
	sdk "github.com/deep2chain/sscq/types"
	"github.com/deep2chain/sscq/x/auth"
	authtx "github.com/deep2chain/sscq/x/auth/client/txbuilder"
...
Example:
ssd livenet --chain-id testchain --v 4 -o output --validator-ip-addresses ip.list --minimum-gas-prices 100satoshi --issuer-bech-address sscq1sh8d3h0nn8t4e83crcql80wua7u3xtlft9sr5d --password-from-file password.list
	`,
