...
import (
	...
	"github.com/deep2chain/sscq/crypto/keys/hd"
	"github.com/deep2chain/sscq/tests"
...
func TestLazyKeyManagement(t *testing.T) {
	...
	require.NoError(t, err)
	addr, err := sdk.AccAddressFromBech32("sscq1w2tysc40u6jaqfd4037s59rp9mxeksrua0kq7f")
	require.NoError(t, err)
